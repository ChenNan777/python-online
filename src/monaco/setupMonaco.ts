...
function defineCustomThemes(): void {
  monaco.editor.defineTheme("python-online-light", {
    ...
    colors: {
      ...
      "editor.selectionBackground": "#D8E9FFB8",
      "editor.inactiveSelectionBackground": "#ECF4FF96",
      "editorGutter.background": "#FFFFFF",
      "editorIndentGuide.background1": "#E8EEF5",
      "editorIndentGuide.activeBackground1": "#B6D2FF",
      "editorLineNumber.border": "#F1F5F9",
      "editorBracketMatch.background": "#ECF5FF",
