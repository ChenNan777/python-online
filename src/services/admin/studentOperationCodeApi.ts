...
/** 保存学生作业代码 保存学生提交的编程代码（支持定位分析和路径规划） POST /StudentOperationCode/save */
export function studentOperationCodeSaveUsingPost({
  body,
  options,
}: {
  ...
  return request<boolean>('/StudentOperationCode/save', {
    method: 'POST',
    headers: {
